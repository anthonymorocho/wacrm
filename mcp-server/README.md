...
**[CRM](https://github.com/anthonymorocho/wacrm)** — the self-hostable
...
It's a thin wrapper over CRM's public [`/api/v1`](../docs/public-api.md)
...
1. A running CRM instance (your own self-hosted deploy).
