            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm font-semibold text-foreground">{t(`templateNames.${slug}.name`)}</div>
                  <p className="mt-1 text-xs text-muted-foreground">{t(`templateNames.${slug}.description`)}</p>
                </button>
              )
            })}
          </div>
