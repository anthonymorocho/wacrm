    ...
    async (acctId: string) => {
      ...
      try {
        ...
        const { data, error } = await supabase
          ...
          .select(
            'id, user_id, phone_number_id, waba_id, status, connected_at, registered_at, subscribed_apps_at, last_registration_error, token_expires_at'
          )
