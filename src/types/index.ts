...
export interface Contact {
  ...
  user_id: string;
  account_id: string;
  /** Social contacts may not expose a phone number. */
  phone: string | null;
...
export interface Conversation {
  ...
  created_at: string;
  updated_at: string;
  /** `whatsapp` is the default for all rows created before Meta channels. */
...
export interface WhatsAppConfig {
  ...
  /** Expiration returned by Meta for an Embedded Signup access token. */
...
export interface QuickReply {
  ...
  /** Optional image attached to a text quick reply. */
  media_url?: string | null;
  /** Storage path used to clean up replaced or deleted quick-reply images. */
  media_path?: string | null;
  /** Original filename shown in the composer preview. */
